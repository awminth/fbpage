                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-one-home-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Supplier Pay</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-one-home1-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false">Supplier Detail</a>
                                </li>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="supplierinout_action.php">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                ...
                                                <div class="form-group">
                                                    <label for="usr"> Supplier :</label>
                                                    <select class="form-control border-success" id="supplierpay"
                                                        name="supplierpay">
                                                        <option value="">Select Supplier</option>
                                                        <?=load_supplier()?>
                                                    </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                ...
                                                <div class="form-group">
                                                    <label for="usr"> Supplier :</label>
                                                    <select class="form-control border-success" id="supplierpay2"
                                                        name="supplierpay2">
                                                        <option value="">Select Supplier</option>
                                                        <?=load_supplier();?>
                                                    </select>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Supplier Pay</h4>
            ...
            <form id="frm" method="POST" enctype="multipart/form-data">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    <div class="form-group">
                        ...
                        <select class="form-control border-success" name="supplierpay1">
                            <option value="">Select Supplier</option>
                            <?=load_supplier();?>
                        </select>
                    </div>
...
<div class="modal fade" id="editmodal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Edit Supplier Pay</h4>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'item/supplierinout_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
