...
if($action == 'show'){  
    ...
    where r.CategoryID=c.AID and r.SupplierID=s.AID ".$a." 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            $out.="<tr>
                ...
                <td>
                    <a href='#' id='btnview' class='dropdown-item dropdown-item-sm text-center'
                        data-aid='{$row['AID']}'
                        data-codeno='{$row['CodeNo']}'
                        data-itemname='{$row['ItemName']}'
                        data-sellprice='{$row['SellPrice']}'><i
                        class='fas fa-print text-success' style='font-size:20px;'></i>
                    </a>
                </td>
            </tr>";
        }
