            ...
            <form id="frm" method="POST">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    <div class="form-group">
                        <label for="usr"> ကုမ္ပဏီအမည် :</label>
                        <input type="text" class="form-control border-success" id="supplier" name="supplier">
                    </div>
                    <div class="form-group">
...
$(document).ready(function() {
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'setting/supplier_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $(document).on("click", "#btnsave", function(e) {
        ...
        var email = $("#email").val();
        var phno = $("#phno").val();
        if (supplier == "" || address == "" || email == "" || phno == "") {
