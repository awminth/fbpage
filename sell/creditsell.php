                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            ...
                            <form method="POST" action="creditsell_action.php">
...
<!-- new Modal -->
<div class="modal fade" id="customerpaymodal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-2" id="customerpayview">
            <!-- Modal Header -->
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'sell/creditsell_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $(document).on("click", "#customerpay", function() {
      ...
      $(document).on('click', '#btnsave', function(e) {
        ...
        $("#customerpaymodal").modal("hide");
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'sell/creditsell_action.php' ?>",
            data: {
                action: 'savecustomerpay',
                customerid: customerid,
                userid: userid,
                vno: vno,
                pay: pay,
