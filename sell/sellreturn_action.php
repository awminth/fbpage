...
if($action == 'show'){  
    ...
    where v.UserID=u.AID and v.CustomerID=c.AID and v.Chk='Return' ".$b.$c.$a." 
...
if($action == 'view'){
    ...
    <div align='center'><img src='".roothtml."lib/images/kg1.jpg' style='width: 100px;height:auto;'></img></div>
...
if($action == 'delete'){
    ...
    if(mysqli_num_rows($result)>0){
        ...
        save_log($_SESSION["eadmin_username"]." သည် vno: ".$vno." ၏ return အရောင်းစာရင်းအားဖျက်သွားသည်။");
        echo 1;
    }else{
        echo 0;
    }
...
if($action == 'excel'){
    ...
    $result = mysqli_query($con,$sql);
    $out="";
    $fileName = "SaleReturnReport-".date('d-m-Y').".xls";
    if(mysqli_num_rows($result) > 0){
        $out .= '<head><meta charset="utf-8"></head>
        <table >  
            <tr>
                <td colspan="10" align="center"><h3>Sale Return Report</h3></td>
            </tr>
            ...
            <tr>  
                ...
                <th style="border: 1px solid ;">Return Amount</th>
        ...
        <table >  
            ...
            <tr>
                <td colspan="10" style="border: 1px solid ;" align="center">No data</td>
            </tr>';
        $out .= '</table>';
        header('Content-Type: application/xls');
        header('Content-Disposition: attachment; filename='.$fileName);
