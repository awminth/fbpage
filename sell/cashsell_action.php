...
if($action == 'view'){
    ...
    <div align='center'><img src='".roothtml."lib/images/logo2.jpg' style='width: 200px;height:200px;'></img></div>
...
if($action == 'delete'){
    ...
    if(mysqli_num_rows($result)>0){
        ...
        save_log($_SESSION["eadmin_username"]." သည် vno: ".$vno." ၏ cash အရောင်းစာရင်းအားဖျက်သွားသည်။");
        echo 1;
    }else{
        echo 0;
    }
