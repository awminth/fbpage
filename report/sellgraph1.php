                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="customer" id="customer">
                                    <option value="h">High Sale Item</option>
                                    <option value="l">Low Sale Item</option>
                                </select>
                            </div>
                            <hr>
                            <div class="form-group">
                            ...
                            <form method="POST" action="sellgraph1_action.php">
                                <input type="hidden" name="hid">
                                <input type="hidden" name="ser">
                                <input type="hidden" name="hfrom">
                                <input type="hidden" name="hto">
                                <input type="hidden" name="hcustomer" value="h">
...
$(document).ready(function() {
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'report/sellgraph1_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
