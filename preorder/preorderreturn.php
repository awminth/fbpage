...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>PreOrder Return စာရင်းများ</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            ...
                            <form method="POST" action="preorderreport_action.php">
                                ...
                                <button type="submit" name="action" value="excel_return"
...
$(document).ready(function() {
    ...
    $(document).on("click", "#btnviewreturn", function() {
        var vno = $(this).data("vno");
        $.ajax({
            type: "post",
            url: ajax_url,
            data: {
                action: 'viewvoucher_return',
                vno: vno
            },
            success: function(data) {
    ...
    $(document).on("click", "#btndeletereturn", function(e) {
        e.preventDefault();
        var vno = $(this).data("vno");
        swal({
